...
<p align="center">
  ...
  <a href="https://t.me/ultroidofficial">
...
* `ultroidxTeam_ADMINS` Optional: A space separated list of user_ids of ultroidxTeam_ADMINS, they can only create links
...
* `ultroidxTeam_botSTATS` put your custom text for stats command, use HTML and <a href='https://github.com/codexbotz/File-Sharing-Bot/blob/main/README.md#custom_stats'>fillings</a>
